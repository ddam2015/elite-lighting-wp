			...
			if ( isset( $_GET['section'] ) && $_GET['section'] == 'register' ) {
				...
				$settings = array(
					...
					'prdctfltr_clearall' => array(
						...
						'type' => 'select',
						'desc' => __( 'Select your Shop/Product Archives Clear All button action. This option works if you do not have filters of same taxonomy as the term in the permalink.', 'prdctfltr' ),
